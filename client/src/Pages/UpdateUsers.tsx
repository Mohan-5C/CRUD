...
export const UpdateUsers = () => {
  ...
  useEffect(() => {
    ...
    // })
    fetchUserData();
    // dispatch(updateAction(id,navigate,form));
  }, [id, form]);
  ...
  const handleSubmit = async (values:{email:string,password:string}) => {
    ...
    // }
    console.log("sending id is", id);
      
    if(id){
      dispatch(updateAction(id, values, navigate));
    }
  else{
    console.log("Cannot update user, ID is undefined");
  }
  };
